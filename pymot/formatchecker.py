...
class FormatChecker:
    r"""
    Checker class that is used for checking the format of groundtruth and
    hypotheses dictionaries.

    Parameters
    ----------
    groundtruth : `dict`
        A dictionary representing the groundtruth tracking annotations. Should
        have the following format:
    hypotheses : `dict`
        A dictionary representing the hypotheses produced by the tracker.
    ...
    def check_ambiguous_ids(self):
        ...
        for frame in self.hypotheses["frames"]:
            ids = set()
    ...
    def check_existing_ids(self):
        ...
        for f in self.hypotheses["frames"]:
